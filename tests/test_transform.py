...
def test_mysql_trans():
    ...
    mock_cursor.execute.assert_has_calls([
        call(model_data["price"].SQL_INSERT, (*model_data["price"].sql_args, model_data["spider_ts"])),
        call(model_data["hashrate"].SQL_INSERT, (*model_data["hashrate"].sql_args, model_data["spider_ts"]))
    ])
